...
const books = [
  ...
  { name: "Деяния", file: "data/john.json" },
  { name: "Иакова", file: "data/john.json" },
  { name: "1 Петра", file: "data/john.json" },
  { name: "2 Петра", file: "data/john.json" },
  { name: "1 Иоанна", file: "data/john.json" },
  { name: "2 Иоанна", file: "data/john.json" },
  { name: "3 Иоанна", file: "data/john.json" },
  { name: "Иуды", file: "data/john.json" },
  { name: "Римлянам", file: "data/john.json" },
  { name: "1 Коринфянам", file: "data/john.json" },
  { name: "2 Коринфянам", file: "data/john.json" },
  { name: "Галатам", file: "data/john.json" },
  { name: "Ефесянам", file: "data/john.json" },
  { name: "Филиппийцам", file: "data/john.json" },
  { name: "Колоссянам", file: "data/john.json" },
  { name: "1 Фессалоникийцам", file: "data/john.json" },
  { name: "2 Фессалоникийцам", file: "data/john.json" },
  { name: "1 Тимофею", file: "data/john.json" },
  { name: "2 Тимофею", file: "data/john.json" },
  { name: "Титу", file: "data/john.json" },
  { name: "Филимону", file: "data/john.json" },
  { name: "Евреям", file: "data/john.json" },
  { name: "Откровение", file: "data/john.json" }
];
